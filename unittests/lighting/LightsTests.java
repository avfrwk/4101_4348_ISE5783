...
public class LightsTests {
    ...
    public void trianglesAllLights() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new SpotLight(trianglesLightColor, trianglesLightPosition, trianglesLightDirection2)
                .setKl(0.003).setKq(0.0001));
        scene2.lights.add(new PointLight(trianglesLightColor2, trianglesLightPosition2)
                .setKl(0.001).setKq(0.0002));
        scene2.lights.add(new DirectionalLight(trianglesLightColor3, trianglesLightDirection));
    ...
    public void sphereAllLights() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new DirectionalLight(sphereLightColor, new Vector(-3, 10, -0.5)));
        scene1.lights.add(new PointLight(sphereLightColor2,sphereLightPosition2 )
                .setKl(0.003).setKq(0.0002));
        scene1.lights.add(new SpotLight(sphereLightColor3, sphereLightPosition, new Vector(1, 1, -0.5))
                .setKl(0.001).setKq(0.0001));
