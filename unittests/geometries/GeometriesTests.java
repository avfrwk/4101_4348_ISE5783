...
class GeometriesTests{
    ...
    void TestFindIntersections() {
        ...
        assertEquals(5,geos.findIntsersections(new Ray(new Point(5,3.5,10),new Vector(0,0,-1))).size(),
    "Geometries's TestFindIntersections is not working properly for when some of the Intersectables are intersects");
        ...
        geos=new Geometries();
        assertNull(geos.findIntsersections(new Ray(new Point(5,5,5),new Vector(1,1,1))),
        ...
        assertNull(geos.findIntsersections(new Ray(new Point(5,3.5,10),new Vector(0,1,0))),
     "Geometries's TestFindIntersections is not working properly for when none of the Intersectables are intersects");
        ...
        assertEquals(1,geos.findIntsersections(new Ray(new Point(15,15,10),new Vector(0,0,-1))).size(),
       "Geometries's TestFindIntersections is not working properly for when just one of the Intersectables is intersects");
        ...
        assertEquals(5/*9*/,geos.findIntsersections(new Ray(new Point(5,3.5,10),new Vector(0,0,-1))).size(),
